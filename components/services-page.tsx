    ...
    services: [
      {
        ...
        color: 'text-orange-400',
        bg: 'bg-orange-500/10 border-orange-500/20',
        title: 'أتمتة الذكاء الاصطناعي للمطاعم',
        sub: 'حجوزات أكثر وطبيات أكثر ورضى العميل أسرع.',
        desc: 'خلينا نكون صريحين… أغلب المطاعم تعاني من نفس المشكلة يومياً: خطوط مشغولة، حجوزات تضيع، ووقت كبير ينصرف على أشياء ممكن تكون أوتوماتيكية. نظامنا الذكي يدير كل تواصل مع ضيوفك — من أول استفسار لحد التقييم بعد الزيارة.',
        features: [
          { icon: Calendar, label: 'حجوزات الطاولات', desc: 'نظام الحجز شغال 24/7 — حتى لما المطعم مسكر، الحجوزات عم تتأكد لحالها بدون تدخل.' },
          { icon: Phone, label: 'أتمتة واتساب', desc: 'الضيف يسأل؟ الرد بيكون فوراً: أوقات العمل، المنيو، التوفر… بدون ما حدا يرد يدوياً.' },
          { icon: Megaphone, label: 'الترويج للفعاليات', desc: 'عندك عرض؟ خصم؟ مناسبة؟ النظام بيبعتها تلقائياً لعملائك المهتمين.' },
          { icon: MessageSquare, label: 'تواصل مع العملاء', desc: 'مساعد ذكي يرد على كل استفسار باحترافية — كأنه موظف عندك، بس 24/7.' },
          { icon: Mail, label: 'المتابعة والتقييمات', desc: 'بعد كل زيارة، بيتم إرسال رسالة متابعة وطلب تقييم بشكل تلقائي.' },
          { icon: Users, label: 'إدارة الولاء', desc: 'نظام CRM ذكي يهتم بعملائك: عروض مخصصة، تهاني، وتواصل مستمر بدون تعب.' },
        ],
        results: ['90% من الحجوزات تتم وتتأكد تلقائياً', 'توفر على فريقك ساعتين يومياً على الأقل', '+35% زيادة في تقييماتك أونلاين'],
        cta: 'احجز استشارة مجانية للمطاعم',
      },
      {
        id: 'cafes',
        icon: Coffee,
        color: 'text-amber-400',
        bg: 'bg-amber-500/10 border-amber-500/20',
        title: 'أتمتة الذكاء الاصطناعي للمقاهي',
        sub: 'عملاء دائمون أكثر. طلبات أكثر. ضغط أقل.',
        desc: 'المقاهي تعيش على العملاء الدائمين — بس المشكلة إن التواصل معهم بياخذ وقت. نحن نخلي كل شيء أسهل: نساعدك ترد فوراً، تدير الطلبات، وتحافظ على عملائك بشكل ذكي.',
        features: [
          { icon: MessageSquare, label: 'الإجابة على أسئلة القائمة', desc: 'أي سؤال عن الأطباق، الأسعار، أو الحساسية؟ الرد بيكون فوري وواضح.' },
          { icon: ShoppingBag, label: 'أتمتة الطلبات', desc: 'طلبات مسبقة + استلام + تأكيد… كله يتم بشكل تلقائي بدون تدخل.' },
          { icon: Users, label: 'ولاء العملاء', desc: 'عروض خاصة وتذكيرات موجهة لعملائك — بشكل ذكي وتلقائي يخليهم يرجعوا.' },
          { icon: Megaphone, label: 'الترويج لعروض اليوم', desc: 'عروض اليوم توصل مباشرة للزبائن عبر واتساب — بدون ما تحتاج ترسل بيدك.' },
          { icon: Mail, label: 'النشرة والمتابعة', desc: 'إيميلات أوتوماتيكية للفعاليات، المنتجات الجديدة، والعروض تصل للعميل في الوقت المناسب.' },
          { icon: Calendar, label: 'الفعاليات والورش', desc: 'إدارة الحجوزات للورش أو الفعاليات الخاصة — بدون تعقيد وبدون فوضى.' },
        ],
        results: ['85% من الأسئلة تنرد تلقائياً بدون جهد', 'زيادة 40% في العملاء الدائمين', 'الطلبات المسبقة تتأكد بدون تدخل'],
        cta: 'احجز استشارة مجانية للمقاهي',
      },
      {
        id: 'services',
        icon: Briefcase,
        color: 'text-blue-400',
        bg: 'bg-blue-500/10 border-blue-500/20',
        title: 'أتمتة الذكاء الاصطناعي لشركات الخدمات',
        sub: 'استفسارات أكثر. عملاء أكثر. إيرادات أعلى.',
        desc: 'خلينا نحكي بصراحة… كم عميل خسرت لأنه ما حدا رد عليه بسرعة؟ سواء كنت صالون أو نادي أو عيادة أو أي عمل خدمي — نظامنا يضمن إنك ما تخسر أي فرصة.',
        features: [
          { icon: Target, label: 'توليد العملاء المحتملين', desc: 'الذكاء الاصطناعي يتعامل مع كل مهتم، يفهمه، ويجهزه كعميل حقيقي — على مدار الساعة.' },
          { icon: Calendar, label: 'حجز المواعيد', desc: 'حجز + تأكيد + تذكير + متابعة… كله تلقائي بدون ما تحرك إصبع.' },
          { icon: Phone, label: 'دعم واتساب', desc: 'ردود فورية على كل الاستفسارات — بدون فريق كبير وبدون انتظار.' },
          { icon: Zap, label: 'تكامل CRM', desc: 'كل بيانات العملاء محفوظة ومحدثة تلقائياً — ما في شيء يضيع.' },
          { icon: Mail, label: 'متابعة تلقائية', desc: 'رسائل متابعة وعروض ترجع العملاء مرة ثانية بدون جهد منك.' },
          { icon: Users, label: 'رعاية العملاء', desc: 'رسائل شخصية، تهاني، وتواصل ذكي يخلي العميل يحس إنك دايماً فاكره.' },
        ],
        results: ['ولا استفسار يضيع', 'سرعة الرد تزيد 60%', '+45% حجوزات أكثر'],
        cta: 'احجز استشارة مجانية لشركات الخدمات',
      },
    ],
    cta: {
      title: 'أي حل يناسبك؟',
      sub: 'كل بزنس مختلف… وعشان هيك نحن ما نعطيك حل جاهز — نعطيك الحل المناسب إلك. احجز استشارة مجانية ونحلل شغلك خطوة بخطوة.',
      btn: 'احجز استشارة مجانية الآن',
    },
  },
};
