...
const defaultResponses = {
  ...
  ar: 'سؤال ممتاز! للحصول على إجابة دقيقة تناسب عملك تحديداً، أوصي بمحادثة قصيرة. يمكنني حينها أن أريك بالضبط ما يحدث أكبر فرق في وضعك. هل لديك أسئلة أخرى؟',
};
...
const tx = {
  ...
  ar: {
    ...
    headline: 'هل أنت مستعد لتشغيل عملك على',
    headlineGradient: 'الطيار الآلي؟',
    sub: 'تحدث مع مستشارنا الذكي أولاً — أو املأ النموذج مباشرة. سيتواصل فريقنا معك خلال 24 ساعة لجلسة استراتيجية مجانية وبدون التزام.',
    chatTitle: 'مستشار أوفيفو الذكي',
    chatSub: 'اسألني أي شيء — أجيب بصدق',
    online: 'متصل',
    placeholder: 'سؤالك...',
    quickLabel: 'أسئلة شائعة',
    formTitle: 'اطلب موعد استشارة',
    formSub: 'مجاني · بدون التزام · رد خلال 24 ساعة',
    nameLabel: 'اسمك',
    ...
    phonePlaceholder: '+49 176 ...',
    companyPlaceholder: 'مطعم بيلا فيستا، قطاع الضيافة',
    messagePlaceholder: 'أدير مطعماً بـ 40 طاولة وأريد أتمتة الحجوزات وواتساب...',
    submitBtn: 'اطلب موعد الاستشارة',
    submitting: 'جارٍ الإرسال...',
    successTitle: 'تم استلام طلبك!',
    successMsg: 'ممتاز! سنتواصل معك خلال 24 ساعة عبر البريد الإلكتروني أو الهاتف — مع خطة محددة لعملك.',
    ...
    statsTitle: 'ما يحققه عملاؤنا',
    stats: [
      { value: '94%', label: 'من الاستفسارات تُجاب تلقائياً' },
      { value: '-70%', label: 'تقليل العمل اليدوي' },
      { value: '+35%', label: 'زيادة الإيرادات في المتوسط' },
      { value: '5–14', label: 'يوماً حتى الإطلاق' },
    ],
    benefitsTitle: 'ما ستحصل عليه في الاستشارة',
    benefits: [
      'تحليل عملك والعقبات الحالية',
      'استراتيجية أتمتة محددة لشركتك',
      'تقييم واضح للتكاليف والعائد على الاستثمار',
      'توصية صادقة — بدون ضغط مبيعات',
    ],
  },
};
...
export function ConsultationPage({ lang }: Props) {
  ...
  function getResponse(userMsg: string): string {
    ...
    const responses = aiResponses[responseLang as keyof typeof aiResponses] ?? aiResponses.de;
