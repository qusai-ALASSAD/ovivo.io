...
export default function FunnelsPage() {
  return (
    <ServicePageLayout
      ...
      heroSubtitle="We don't just build pretty websites. We build full conversion systems — landing pages, sales funnels, and booking flows that turn visitors into paying customers."
      heroImage={heroImage}
