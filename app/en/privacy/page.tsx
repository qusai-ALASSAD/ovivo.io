...
const sections = [
  ...
  },
  {
    ...
    content: `We have implemented appropriate security measures to prevent your personal data from being accidentally lost, used, or accessed in an unauthorised way. We limit access to your personal data to those employees and partners who have a business need to know.`,
  },
  {
  ...
  },
  {
    ...
    content: `We may use third-party services that collect, monitor and analyse data:`,
    list: [
  ...
  },
  {
    ...
    list: ['Email: privacy@ovivo.io', 'Website: ovivo.io/en/contact'],
  },
];
