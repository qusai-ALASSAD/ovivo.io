...
export const content = {
  ...
  ar: {
    ...
    hero: {
      ...
      headline1: 'عملك يمتلئ بالعملاء',
      headline2: 'بدون أي جهد يدوي منك.',
      sub: 'اجذب المزيد من العملاء بدون أي جهد يدوي. مع Ovivo يتم الرد على جميع الاستفسارات وتأكيد الحجوزات تلقائياً على مدار الساعة. وفّر وقتك وركّز على تطوير عملك.',
    ...
    offer: {
      ...
      titleGradient: 'مضمونة أو نواصل مجاناً.',
    ...
    problems: {
      ...
      subtitle: 'هذه المشاكل تكلف المطاعم وشركات الخدمات أموالاً حقيقية كل يوم. وكلها قابلة للأتمتة الكاملة.',
      items: [
        {
