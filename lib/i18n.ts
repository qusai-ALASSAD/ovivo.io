...
export const content = {
  de: {
    ...
    hero: {
      ...
      headline1: 'Mehr Buchungen.',
      headline2: 'Weniger manuelle Arbeit.',
      sub: 'Ovivo übernimmt Reservierungen, Kundenanfragen und Nachverfolgung — vollautomatisch, rund um die Uhr. Kein IT-Aufwand. Keine Extra-Mitarbeiter. Ergebnisse ab Tag 1.',
      cta: 'Kostenlose Beratung anfragen',
      ctaSecondary: 'Wie es funktioniert',
      trust: ['Einrichtung in 5–14 Tagen', 'Monatlich kündbar', 'Kein IT-Wissen nötig'],
    },
    offer: {
      badge: 'Unser Versprechen',
      title: 'Mehr Kunden in 30 Tagen —',
      titleGradient: 'oder wir überarbeiten es kostenlos.',
      sub: 'Wir bauen kein Standard-System. Wir analysieren Ihren Betrieb, identifizieren genau wo Sie Umsatz verlieren, und entwickeln eine Lösung, die für Sie funktioniert.',
      items: [
        { stat: '94%', label: 'Anfragen automatisch beantwortet' },
        { stat: '-3h', label: 'Weniger manuelle Arbeit täglich' },
        { stat: '+35%', label: 'Mehr Buchungen im Durchschnitt' },
        { stat: '5–14', label: 'Tage bis zur Aktivierung' },
      ],
    },
    problems: {
  ...
  en: {
    ...
    hero: {
      ...
      headline1: 'More bookings.',
      headline2: 'Less manual work.',
      sub: 'Ovivo handles reservations, customer inquiries, and follow-ups — fully automated, 24/7. No IT setup. No extra staff. Results from day one.',
      cta: 'Book a Free Consultation',
      ctaSecondary: 'See How It Works',
      trust: ['Live in 5–14 days', 'Cancel anytime', 'No IT knowledge required'],
    },
    offer: {
      badge: 'Our Promise',
      title: 'More customers in 30 days —',
      titleGradient: 'or we fix it for free.',
      sub: "We don't build generic systems. We analyze your business, identify exactly where you're losing revenue, and build a solution that actually works for you.",
      items: [
        { stat: '94%', label: 'Inquiries answered automatically' },
        { stat: '-3h', label: 'Less manual work per day' },
        { stat: '+35%', label: 'More bookings on average' },
        { stat: '5–14', label: 'Days until you go live' },
      ],
    },
    problems: {
  ...
  ar: {
    ...
    hero: {
      ...
      headline1: 'حجوزات أكثر.',
      headline2: 'عمل يدوي أقل.',
      sub: 'أوفيفو يتولى الحجوزات والاستفسارات والمتابعة — بشكل تلقائي كامل، 24 ساعة. بدون خبرة تقنية. بدون موظفين إضافيين. نتائج من اليوم الأول.',
      cta: 'احجز استشارة مجانية',
      ctaSecondary: 'شاهد كيف يعمل',
      trust: ['تشغيل خلال 5–14 يوماً', 'إلغاء في أي وقت', 'لا حاجة لأي خبرة تقنية'],
    },
    offer: {
      badge: 'وعدنا لك',
      title: 'عملاء أكثر في 30 يوماً —',
      titleGradient: 'أو نصلحه مجاناً.',
      sub: 'نحن لا نبني أنظمة جاهزة. نحلل عملك، نحدد بالضبط أين تضيع إيراداتك، ونبني لك الحل الذي يناسبك فعلاً.',
      items: [
        { stat: '94%', label: 'من الاستفسارات تُجاب تلقائياً' },
        { stat: '-3س', label: 'توفير يومي في العمل اليدوي' },
        { stat: '+35%', label: 'زيادة في الحجوزات بالمتوسط' },
        { stat: '5–14', label: 'يوم حتى تشغيل النظام' },
      ],
    },
    problems: {
